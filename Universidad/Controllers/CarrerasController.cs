...
namespace Universidad.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdCarrera,Descripcion")] Carreras carreras)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdCarrera,Descripcion")] Carreras carreras)
        {
            if (ModelState.IsValid)
            {
